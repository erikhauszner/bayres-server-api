...
const io = new SocketIOServer(server, {
  cors: {
    origin: ['http://api.bayreshub.com', 'https://api.bayreshub.com', 'https://panel.bayreshub.com', 'https://http://147.93.36.93:3001', 'http://http://147.93.36.93:3000', 'https://n8n.bayreshub.com', 'http://n8n.bayreshub.com'],
    methods: ["GET", "POST"],
    credentials: true,
